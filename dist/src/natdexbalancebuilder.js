...
function getRandomMon(team) {
    ...
    let completed = false;
    while (!completed) {
        let rand = natdexsets_json_1.default[getRandomInt(natdexsets_json_1.default.length - 1)];
        if (isValid(rand, team) && zMegaCheckPassed(rand) && clericTest(rand)) {
        ...
        a++;
        if (a > 1000) {
            return (natdexsets_json_1.default[getRandomInt(natdexsets_json_1.default.length - 1)]);
        }
    }
}
//# sourceMappingURL=natdexbalancebuilder.js.map